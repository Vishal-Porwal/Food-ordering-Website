<div class="pt-footer">
	<div class="container">
		<div class="row">
			<div class="col-3">
				<div class="pt-logo">
					<a href="#"><i class="fas fa-hamburger"></i> iFood</a>
				</div>
				<div class="pt-social">
          ...
          ?>
			...
			<div class="col-3">
				<div class="pt-copy">
					...
					Copyright &copy; 2022 <a href="<?=path?>">Vishal Food's</a>.<br> All Rights Reserved.
					 <i class="fas fa-heart text-danger"></i> by Suyash  <a href="" target="_blanc"></a><br> ❤️ Sir AKASH CHAUDHARY❤️
				</div>
			</div>
		</div>
	</div>
